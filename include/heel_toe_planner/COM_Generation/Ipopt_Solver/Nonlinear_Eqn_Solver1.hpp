#ifndef NONLINEAR_EQN_SOLVER1_HPP
#define NONLINEAR_EQN_SOLVER1_HPP
...
class NLP1: public Ipopt::TNLP
{
    public:
        NLP1();

        NLP1(Ipopt::Number yzmp_1, Ipopt::Number delta13, Ipopt::Number yzmp_1_prime, Ipopt::Number yzmp_3);
    ...
    private:
        Ipopt::Number yzmp_1;
        Ipopt::Number delta13;
        Ipopt::Number yzmp_1_prime;
        Ipopt::Number yzmp_3;
        NLP1(const NLP1&);
...
#endif // NONLINEAR_EQN_SOLVER1_HPP
