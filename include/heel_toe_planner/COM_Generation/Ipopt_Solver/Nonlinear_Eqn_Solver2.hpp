#ifndef NONLINEAR_EQN_SOLVER2_HPP
#define NONLINEAR_EQN_SOLVER2_HPP
...
class NLP2: public Ipopt::TNLP
{
    public:
        NLP2();

        NLP2(Ipopt::Number lthigh, Ipopt::Number lshank, Ipopt::Number lfoot, Ipopt::Number lstep,
...
#endif // NONLINEAR_EQN_SOLVER2_HPP
