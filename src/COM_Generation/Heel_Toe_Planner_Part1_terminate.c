/*
 * Heel_Toe_Planner_Part1_terminate.c
 *
...
void Heel_Toe_Planner_Part1_terminate(void)
{
  /* (no terminate code required) */
}

void Delete_emxArry(emxArray_real_T *array)
{
    free(array->data);
    array->data = NULL;
    free(array->size);
...
/* End of code generation (Heel_Toe_Planner_Part1_terminate.c) */
